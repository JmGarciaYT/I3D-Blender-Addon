...
udim_mapping = {
    '48_Chromelessshiny.png': {'name': '48 Chrome Less Shiny',                         'offset': [0, 6]},
    '49_Fabric.png': {'name': '49 Fabric',                                             'offset': [1, 6]},
    '50_Wip.png': {'name': 'WIP1',                                                     'offset': [2, 6]},
    '51_Wip.png': {'name': 'WIP2',                                                     'offset': [3, 6]},
    '52_Wip.png': {'name': 'WIP3',                                                     'offset': [4, 6]},
    '53_Wip.png': {'name': 'WIP4',                                                     'offset': [5, 6]},
    '54_Wip.png': {'name': 'WIP5',                                                     'offset': [6, 6]},
    '55_Wip.png': {'name': 'WIP6',                                                     'offset': [7, 6]},
    '40_ShinyCarPaint.png': {'name': 'Shiny Car Paint',                             'offset': [0, 5]},
    '41_Fabric.png': {'name': 'Fabric',                                             'offset': [1, 5]},
    '42_Wood.png': {'name': 'Wood',                                                 'offset': [2, 5]},
    '43_SilverScratchedShiny.png': {'name': 'Silver Scratched Shiny',               'offset': [3, 5]},
    ...
    '32_GraphiteBlack.png': {'name': 'Graphite Black Painted Metal',                'offset': [0, 4]},
    '33_HalfMetalBlack.png': {'name': 'Half Metal Noise',                           'offset': [1, 4]},
    '34_GrayPlastic.png': {'name': 'Gray Shiny Plastic',                            'offset': [2, 4]},
    ...
    '24_GearStickPlastic.png': {'name': 'Gear Shift Stick Plastic',                 'offset': [0, 3]},
    '25_Leather.png': {'name': 'Leather',                                           'offset': [1, 3]},
    '26_PerforatedFabric.png': {'name': 'Perforated Synthetic Fabric',              'offset': [2, 3]},
    '27_GlassClear.png': {'name': 'Glass Clear',                                    'offset': [3, 3]},
    '28_GlassSquare.png': {'name': 'lass Square',                                  'offset': [4, 3]},
    '29_GlassLines.png': {'name': 'Glass Lines',                                    'offset': [5, 3]},
    '30_Palladium.png': {'name': 'Palladium',                                       'offset': [6, 3]},
    '31_Bronze.png': {'name': 'Bronze',                                             'offset': [7, 3]},
    '16_PaintedMetalBlack.png': {'name': 'Painted Metal',                           'offset': [0, 2]},
    ...
    '20_ReflectorWhite.png': {'name': 'eflector White',                            'offset': [4, 2]},
    '21_ReflectorRed.png': {'name': 'Reflector Red',                                'offset': [5, 2]},
    '22_ReflectorOrange.png': {'name': '22 Reflector Orange',                          'offset': [6, 2]},
    ...
    '01_PaintedPlastic.png': {'name': 'ainted Plastic',                             'offset': [1, 0]},
    ...
    '07_Fabric.png': {'name': '7 Fabric',                                              'offset': [7, 0]},
    '7_colorMat0.png': {'name': 'Color Material 0',                                    'offset': [0, -1]},
    '6_colorMat0.png': {'name': 'Color Material 1',                                    'offset': [1, -1]},
    '5_colorMat0.png': {'name': 'Color Material 2',                                    'offset': [2, -1]},
    '4_colorMat0.png': {'name': 'Color Material 3',                                    'offset': [3, -1]},
    '3_colorMat0.png': {'name': 'Color Material 4',                                    'offset': [4, -1]},
    '2_colorMat0.png': {'name': 'Color Material 5',                                    'offset': [5, -1]},
    '1_colorMat0.png': {'name': 'Color Material 6',                                    'offset': [6, -1]},
    '0_colorMat0.png': {'name': 'Color Material 7',                                    'offset': [7, -1]},
}
